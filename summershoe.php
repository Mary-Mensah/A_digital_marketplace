...
<html lang="en">
  ...
  <body id="top">
    ...
    - #HERO
    -->
        <section class="section hero" style="background-image: url('./assets/images/Shoes/shoes-banner.jpg')">
            <div class="container">

            <h2 class="h1 hero-title">
                <strong>SUMMER SHOE FOR YOUR CONVENIENCE</strong>
            </h2>

            <p class="hero-text">
                Discover our Premium Quality and Affordable Shoes. 
          ...
          <div class="container">
            <div class="special-product">
              ...
              <h2 class="h2 section-title">
                <span class="text">SUMMER SHOES</span>
