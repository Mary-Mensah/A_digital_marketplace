...
<html lang="en">
  ...
  <body id="top">
    ...
    - #HERO
    -->
        <section class="section hero" style="background-image: url('./assets/images/clothes/banner-1.jpg')">
            <div class="container">

            <h2 class="h1 hero-title">
                <strong>CLOTHING FOR YOUR CONVENIENCE</strong>
            </h2>
        ...
        <div class="container">
          ...
          <div class="footer-link-box">
            ...
            <ul class="footer-list">
              ...
              <li>
                <a href="clothing.html" class="footer-link">
                  <ion-icon name="chevron-forward-outline"></ion-icon>
